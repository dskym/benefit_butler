...
export const MERCHANT_KEYWORDS: Record<string, string[]> = {
  // 식비: 카페 + 편의점 + 마트/슈퍼 + 외식/배달
  식비: [
    '스타벅스', '이디야', '투썸', '할리스', '메가커피', '빽다방', '커피빈', '폴바셋',
    'GS25', 'CU', '세븐일레븐', '이마트24', '미니스톱',
    '이마트', '홈플러스', '롯데마트', '코스트코', '하나로마트',
    '맥도날드', '버거킹', '롯데리아', 'KFC', '파파존스', '도미노', '피자헛',
    '교촌', 'BBQ', 'bhc', '굽네치킨',
  ],
  // 교통: 대중교통 + 주유소 (주유비는 교통비로 분류)
  교통: [
    '지하철', '버스', '카카오T', '우티', '코레일', 'KTX',
    'SK주유소', 'GS칼텍스', '현대오일뱅크', 'S-OIL', '오일뱅크',
  ],
  쇼핑: ['쿠팡', '11번가', 'G마켓', '옥션', '무신사', '올리브영'],
  '의료·건강': ['약국', '병원', '의원', '클리닉', '한의원', '치과', '안과'],
  '주거·통신': ['SKT', 'KT', 'LGU+', 'LG유플러스', 'SK텔레콤'],
};
